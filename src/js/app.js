App = {
     ...
     displayZombie: function (id, name, dna, level, readyTime, winCount, lossCount) {
          ...
          // Question 1: Answer: Added zombie Id to the zombie list
          ...
          var background_color = '#'+App.randomHex(dna);
          var color = '#'+App.invertHex(background_color);
          zombieTemplate.find('.panel-heading').attr('style','background-color:'+background_color+';color:'+color);
     ...
     invertHex: function (HexCol) {
          var HexInt = parseInt(HexCol, 16);
          var HexCompl = 0xffffff ^ HexInt;
          return HexCompl;
     },
